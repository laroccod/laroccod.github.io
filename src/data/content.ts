/** Single source of truth for all site text, transcribed from the old site's
 * src/data/content.py (itself transcribed from a private resume). The private
 * content/ material, in particular the phone number, stays OFF this site. */
...
export const FIG_BRS_111: Figure = {
  src: "/papers/simulating-hnls/111-brs.png",
  caption:
...
export const FIG_ATLAS_FASER: Figure = {
  src: "/papers/characterizing-hnls/atlas-faser.png",
  caption:
...
export const THESIS_TITLE =
  ...
  "Physics Experiments";
export const THESIS_URL = "https://escholarship.org/uc/item/25v386s5";
export const DEFENSE_SLIDES = "/talks/thesis-defense.pdf";
export const THESIS_BLURB =
...
export const THESIS_FIGURES: Figure[] = [FIG_BRS_111, FIG_ATLAS_FASER];
// Transcribed from the dissertation front matter.
export const THESIS_ABSTRACT =
...
export const SKILLS: SkillGroup[] = [
  {
    name: "Languages",
    items: [
      "Python (NumPy, SciPy, pandas, Matplotlib, Scikit-HEP)",
      "Bash",
      "LaTeX",
    ],
  },
  {
    name: "Scientific computing & modeling",
    items: [
  ...
  },
  {
    ...
    items: [
      "Open-source package design & maintenance",
  ...
  },
  {
    ...
    items: ["Unix/Linux", "HPC clusters (Slurm)", "SSH-based remote workflows"],
  },
  {
    name: "Domain knowledge",
    items: [
      "Accelerator-based experiments (LHC, FASER, fixed-target beams)",
      "Detector acceptance modeling",
      "BSM phenomenology",
...
export const EDUCATION: Education[] = [
  ...
  },
  {
    ...
    details: ["Dean's List · Peter Christian Hernandez Memorial Scholarship"],
  },
];
...
export const PUBLICATIONS: Publication[] = [
  {
    ...
    title:
      "Characterizing Heavy Neutral Leptons: Measuring Parameters, " +
    ...
    figures: [
      FIG_ATLAS_FASER,
      {
        src: "/papers/characterizing-hnls/1d-e.png",
        caption:
      ...
      {
        src: "/papers/characterizing-hnls/fit-2.png",
        caption:
      ...
      {
        src: "/papers/characterizing-hnls/lam-2.png",
        caption:
  ...
  },
  {
    ...
    title:
      "Simulating heavy neutral leptons with general couplings at " +
    ...
    figures: [
      {
        src: "/papers/simulating-hnls/faser-pr-111.png",
        caption:
  ...
  },
  {
    ...
    title:
      "Probing remdesivir nucleotide analogue insertion to SARS-CoV-2 " +
    ...
    figures: [
      {
        src: "/papers/remdesivir-insertion/rdv-atp-insertion.jpg",
        caption:
  ...
  },
  {
    ...
    venue:
      "Computational and Structural Biotechnology Journal 19, 3339–3348",
    year: "2021",
    url: "https://doi.org/10.1016/j.csbj.2021.06.005",
    figures: [
      {
        src: "/papers/nucleotide-selectivity/polymerase-motifs.jpg",
        caption:
...
export const PRESENTATIONS: Presentation[] = [
  {
    ...
    previews: [
      "/talks/previews/thesis-defense-1.jpg",
  ...
  },
  {
    ...
    event: "9th Forward Physics Facility Meeting",
    where: "CERN",
    title:
      "Characterizing Heavy Neutral Leptons: Measuring Parameters, " +
      "Discriminating Majorana versus Dirac, and Using FASER2 as a " +
  ...
  },
  {
    ...
    event: "HET Lunch Seminar",
    where: "Brookhaven National Laboratory",
    title:
      "Simulating and Characterizing Heavy Neutral Leptons at Forward " +
      "Physics Experiments",
    url: "https://indico.bnl.gov/event/30171/",
    slides: "/talks/hnl-seminar-2025.pdf",
    previews: [
      "/talks/previews/hnl-seminar-2025-1.jpg",
  ...
  },
  {
    ...
    previews: [
      "/talks/previews/susy-2025-1.jpg",
  ...
  },
  {
    ...
    where: "Anaheim, CA",
    title:
      "Characterizing long-lived particles at forward-physics " +
  ...
  },
  {
    ...
    previews: [
      "/talks/previews/flasy-2024-1.jpg",
...
export const COURSES_PREPARED: SkillGroup[] = [
  {
  ...
  {
    name: "Astronomy",
    items: ["Introductory astronomy"],
  },
];

export const MENTORING: string[] = [
...
export const CONTACT_LINKS: Link[] = [
  ...
  { label: "LinkedIn", url: "https://www.linkedin.com/in/laroccod/", icon: "WORK" },
  { label: "ORCID", url: "https://orcid.org/0000-0001-6565-8637", icon: "BADGE" },
];
